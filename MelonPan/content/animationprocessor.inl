...
#define animationprocessor__doCallback() animationprocessor::curveEvaluated(currentShot->uniformName(i), element, value, screenWidth, screenHeight)
#define animationprocessor__doFinalize() animationprocessor::finalize(program)
