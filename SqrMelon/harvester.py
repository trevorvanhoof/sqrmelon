...
def main() -> None:
    ...
    outputPath = FilePath(sys.argv[2]).join('content', 'generated.hpp') if len(sys.argv) > 2 else FilePath(__file__).abs().parent().parent().join('MelonPan', 'content', 'generated.hpp')
